using Tyuiu.MarkovSE.Sprint4.Task5.V26.Lib;
namespace Tyuiu.MarkovSE.Sprint4.Task5.V26
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #4 | Выполнил: Марков С.Е. | ИCПБ-24-1";
            ...
            Console.WriteLine("* Выполнил: Марков С.Е. | ИCПБ-24-1                                       *");
            Console.WriteLine("***************************************************************************");
